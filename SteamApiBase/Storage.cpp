...
void Storage::dw_storage_get_user_file(bdByteBuffer& data)
{
	...
	PMAsync<PMGetUserFileResult>* async = PM_GetUserFile(filename, myPmID, fileBuffer, sizeof(fileBuffer));
...
void Storage::dw_storage_upload_user_file(bdByteBuffer& data)
{
	...
	PMAsync<PMWriteUserFileResult>* async = PM_WriteUserFile(filename, myPmID, (uint8_t*)filedata, filelen);
