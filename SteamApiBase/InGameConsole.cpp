...
const char* ConsoleTitle = "Plusmaster T6>";
...
void DrawConsole()
{
	Addresses::R_AddCmdDrawText("Pl^1usmaster^7 v2 LAN", 0x7FFFFFFF, NormalFont, 20.0f, 40.0f, 1.0f, 1.0f, 0, tColor{ 1.0f, 1.0f, 1.0f, 0.05f }, 0);
	if (ConsoleOpen)
	{
